...
InstructionValueDescriptor = _reflection.GeneratedProtocolMessageType('InstructionValueDescriptor', (_message.Message,), {
...
InstructionDescriptor = _reflection.GeneratedProtocolMessageType('InstructionDescriptor', (_message.Message,), {
...
UIDMap = _reflection.GeneratedProtocolMessageType('UIDMap', (_message.Message,), {

  'InstMapEntry' : _reflection.GeneratedProtocolMessageType('InstMapEntry', (_message.Message,), {
  ...
  'FuncMapEntry' : _reflection.GeneratedProtocolMessageType('FuncMapEntry', (_message.Message,), {
...
_UIDMAP_INSTMAPENTRY._options = None
_UIDMAP_FUNCMAPENTRY._options = None
