...
#ifndef NO_OPENMP
#pragma omp parallel firstprivate(vN)
#endif
  {
...
#else
#pragma omp for nowait schedule(static, STATIC_CHUNK_SIZE) firstprivate(a, b)
#endif
#else
...
#pragma ss stream_name "gfm.dot_prod.A.ld"
      ValueAVX valA = ValueAVXLoad(a + i * vLen);

#pragma ss stream_name "gfm.dot_prod.B.ld"
      ValueAVX valB = ValueAVXLoad(b + i * vLen);
