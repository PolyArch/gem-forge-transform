...
/*
 * Disable timing in the output so that we can use the output for correctness
 * testing.
 */
#ifndef USE_CLOCK
#define clock() 0
...
int dummy(TYPE[LEN], TYPE[LEN], TYPE[LEN], TYPE[LEN], TYPE[LEN],
          TYPE[LEN2][LEN2], TYPE[LEN2][LEN2], TYPE[LEN2][LEN2], TYPE);
...
static inline TYPE f(TYPE a, TYPE b) { return a * b; }

void check(int name) {

#ifndef LLVM_TDG_SKIP_CHECK
  TYPE suma = 0;
  TYPE sumb = 0;
  TYPE sumc = 0;
  TYPE sumd = 0;
...
#ifdef LLVM_TDG_VEC_WIDTH
#pragma clang loop vectorize(enable) vectorize_width(LLVM_TDG_VEC_WIDTH)
#endif
    for (int i = 0; i < lll; i++) {
      //			a[i] = b[i] + c[i];
      //			X[i] = (Y[i] * Z[i])+(U[i]*V[i]);
    ...
    dummy((TYPE *)X, (TYPE *)Y, (TYPE *)Z, (TYPE *)U, (TYPE *)V, aa, bb, cc,
          0.);
  }
  end_t = clock();
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S000\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
#pragma clang loop vectorize(enable) vectorize_width(LLVM_TDG_VEC_WIDTH)
  ...
  DPRINTF("S1111\t %.2f \t\t ", clock_dif_sec);
  check(1);
  return 0;
}
...
int s1112() {
  ...
  DPRINTF("S1112\t %.2f \t\t ", clock_dif_sec);
  check(1);
  return 0;
}
...
int s1113() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1113\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s115() {
  ...
  for (int nl = 0; nl < ntimes / LEN2; nl++) {
    for (int j = 0; j < LEN2; j++) {
...
int s1115() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1115\t %.2f \t\t", clock_dif_sec);
  ;
  check(11);
  return 0;
}
...
int s118() {
  ...
  for (int nl = 0; nl < ntimes / LEN2 / LEN2; nl++) {
...
int s1119() {
  ...
  DPRINTF("S1119\t %.2f \t\t ", clock_dif_sec);
  check(11);
  return 0;
}
...
int s1161() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1161\t %.2f \t\t", clock_dif_sec);
  ;
  check(13);
  return 0;
}
...
int s1213() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1213\t %.2f \t\t", clock_dif_sec);
  ;
  check(12);
  return 0;
}
...
int s1221() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1221\t %.2f \t\t", clock_dif_sec);
  ;
  check(12);
  return 0;
}
...
int s1232() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1232\t %.2f \t\t", clock_dif_sec);
  ;
  check(11);
  return 0;
}
...
int s2233() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2233\t %.2f \t\t", clock_dif_sec);
  ;
  check(1122);
  return 0;
}
...
int s1244() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1244\t %.2f \t\t", clock_dif_sec);
  ;
  check(12);
  return 0;
}
...
int s2244() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2244\t %.2f \t\t", clock_dif_sec);
  ;
  check(12);
  return 0;
}
...
int s1251() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1251\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s2251() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2251\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s3251() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S3251\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s2275() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2275\t %.2f \t\t", clock_dif_sec);
  ;
  check(11);
  return 0;
}
...
int s1279() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1279\t %.2f \t\t", clock_dif_sec);
  ;
  check(123);
  return 0;
}
...
int s2710(TYPE x) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2710\t %.2f \t\t", clock_dif_sec);
  ;
  check(123);
  return 0;
}
...
int s2711() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2711\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s2712() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2712\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s1281() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1281\t %.2f \t\t", clock_dif_sec);
  ;
  check(12);
  return 0;
}
...
int s2101() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2101\t %.2f \t\t", clock_dif_sec);
  ;
  check(11);
  return 0;
}
...
int s2102() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2102\t %.2f \t\t", clock_dif_sec);
  ;
  check(11);
  return 0;
}
...
int s2111() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S2111\t %.2f \t\t", clock_dif_sec);
  ;
  temp = 0.;
  for (int i = 0; i < LEN2; i++)
    for (int j = 0; j < LEN2; j++)
...
int s31111() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S31111\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s3110() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S3110\t %.2f \t\t", clock_dif_sec);
  ;
...
int s13110() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S13110\t %.2f \t\t", clock_dif_sec);
  ;
  temp = max + xindex + 1 + yindex + 1;
  check(-1);
  return 0;
...
int s3111() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S3111\t %.2f \t\t", clock_dif_sec);
  ;
  temp = sum;
  check(-1);
  return 0;
...
int s3112() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S3112\t %.2f \t\t", clock_dif_sec);
  ;
  temp = sum;
  check(-12);
  return 0;
...
int s3113() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S3113\t %.2f \t\t", clock_dif_sec);
  ;
  temp = max;
  check(-1);
  return 0;
...
int s1351() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1351\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s1421() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S1421\t %.2f \t\t", clock_dif_sec);
  ;
  temp = 0;
  for (int i = 0; i < LEN / 2; i++) {
    temp += xx[i];
...
int s4112(int *__restrict__ ip, TYPE s) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4112\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s4113(int *__restrict__ ip) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4113\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s4114(int *ip, int n1) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4114\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s4115(int *__restrict__ ip) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4115\t %.2f \t\t", clock_dif_sec);
  ;
  temp = sum;
  check(-1);
  return 0;
...
int s4116(int *__restrict__ ip, int j, int inc) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4116\t %.2f \t\t", clock_dif_sec);
  ;
  temp = sum;
  check(-1);
  return 0;
...
int s4117() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4117\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int s4121() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("S4121\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int vpvtv() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("vpvtv\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int vpvts(TYPE s) {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("vpvts\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int vpvpv() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("vpvpv\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int vtvtv() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("vtvtv\t %.2f \t\t", clock_dif_sec);
...
int vsumr() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("vsumr\t %.2f \t\t", clock_dif_sec);
  ;
  check(1);
  return 0;
}
...
int vdotr() {
  ...
  clock_dif = end_t - start_t;
  clock_dif_sec = (double)(clock_dif / 1000000.0);
  DPRINTF("vdotr\t %.2f \t\t", clock_dif_sec);
  ;
  temp = dot;
  check(-1);
  return 0;
...
// A hack to run a single test function.
#ifdef LLVM_TDG_GEM5_BASELINE
  m5_work_begin(0, 0);
  m5_reset_stats(0, 0);
#endif
